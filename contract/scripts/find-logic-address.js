...
(async ()=>{
    ...
    var currentNFTProxyAddress = '0x73E51E191090c117526B446dFdA259c1473c5f66';
    var LPNFT = await ethers.getContractFactory("LaPrairieNFTTestNet");

    if (chainId == 1)
    {
        currentNFTProxyAddress = '0x28d5B2E6f30A9b54DCBE8792543fB0232F4f3658';
        LPNFT = await ethers.getContractFactory("LaPrairieNFTProduction");
    }
    else if (chainId == 4)
    {
        currentNFTProxyAddress = '0x73E51E191090c117526B446dFdA259c1473c5f66'; //On Rinkeby
    } 

	const currentProxyLogicAddress = await getImplementationAddress(ethers.provider, currentNFTProxyAddress);
...
// npx hardhat run scripts/find-logic-address.js --network ...